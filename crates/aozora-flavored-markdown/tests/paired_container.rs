...
fn indent_container_wraps_body_with_div() {
    ...
    assert!(
        html.contains(
            r#"<div class="aozora-md-container aozora-md-container-indent aozora-md-container-indent-1" data-amount="1">"#,
        ),
...
fn keigakomi_inside_indent_wraps_via_two_passes() {
    ...
    let indent_open_at = html
        .find("aozora-md-container-indent")
        .expect("indent open present");
    let keigakomi_open_at = html
        .find("aozora-md-container-keigakomi")
...
fn cross_family_nest_preserved_only_same_family_cascades() {
    ...
    let keigakomi_open = html.find("aozora-md-container-keigakomi").unwrap();
    let indent_open = html.find("aozora-md-container-indent-2").unwrap();
    assert!(
