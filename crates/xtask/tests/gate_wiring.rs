...
/// member's own page.
///
/// Walked rather than listed, because the defect these rules exist for is a
/// copy nobody knew about. The three listed roots this replaced missed all
/// five crate READMEs — the pages a reader meets first, published inside the
/// packages themselves — and `.github/`, whose pull-request template
/// addresses a contributor at the moment the claims in it are being acted on.
///
